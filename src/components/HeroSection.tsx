      ...
      />
        ...
        <div className='p-4 relative z-10 w-full text-center'>
            ...
            <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>
                Dive into our comprehensive music courses and transform your musical journey today , whether you
                re a beginner or looking to refine your skills , join us to unlock you true potential 
            </p>
